...
| 10月 | 25人 | 134人 | 33人 | 192人 | ¥1,440,000 | ¥3,375,000 |
| 11月 | 26人 | 187人 | 50人 | 263人 | ¥1,972,500 | ¥5,347,500 |
| 12月 | 26人 | 249人 | 96人 | 371人 | ¥2,782,500 | ¥8,130,000 |

※Q3（7-9月）はO2O売上 ¥1,875,000 が加算される

### O2O必要量の逆算（目標一致型）

| 項目 | 計算値 | 備考 |
|------|--------|------|
| オンラインのみ年間売上 | ¥8,130,000 | メルマガ+SNS+リピート |
| 目標との乖離 | ¥1,870,000 | O2Oで補填 |
| **必要顧客数** | **250人** | 反復計算で最適化 |
| 必要接点数 | 32,467人 | |
| **週末1日あたり便数** | **3.1便** | ✓ 現実的 |
...
| 項目 | 目標値 | シミュレーション値 | 判定 |
|------|--------|-------------------|------|
| 年間売上 | ¥10,000,000 | ¥10,005,000 | ✓ +0.1% |
| 平均単価 | ¥7,500 | ¥7,500 | ✓ 一致 |
| リピート率 | 20% | 16.9% | △ やや低め |
| 粗利 | ¥1,500,000 | ¥1,500,750 | ✓ +0.1% |
...
| Y1 10百万円達成 | **高** | 目標一致型モデルで乖離0.1%、O2O便数も3.1便で余裕あり |
| 5か年計画達成 | **中〜高** | BtoB展開とMP化で達成可能、Y4の成長率186%が要注意 |

### 新モデルの主要な改善点

1. **O2Oの考え方を刷新**: トップダウン → オンライン連続成長 + 乖離補填（反復計算で最適化）
2. **目標一致型に改善**: 売上超過ではなく、目標にピッタリ一致するO2O顧客数を逆算
3. **O2O便数に余裕**: 5便/日→3.1便/日に削減、実現可能性向上
4. **5か年計画にBtoBを織り込み**: Y2以降の成長ドライバーを具体化
...
| 項目 | 基準値 | アラート基準 |
|------|--------|-------------|
| O2O便数 | 3.1便/日 | 4便以上必要になった場合 |
| Q4売上進捗 | 10月末¥3.4M累計 | ¥3.0M未満 |
